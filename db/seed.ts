...
async function createUsers(emails: string[], authService: AuthService, password: string, users: { id: string; name: string | null; email: string | null; emailVerified: Date | null; image: string | null; password: string | null; role: "USER" | "ADMIN"; }[]) {
